<div>
    <button class="px-5 py-1 rounded-full flex items-center justify-center gap-2 {{ $btn_type }}" type="button"
        wire:click="submit" wire:loading.attr="disabled" wire:loading.class="btn-loading">
